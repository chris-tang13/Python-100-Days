...
def getShifts(orgId):
    url='https://oretail-ind.myoppo.com/biz-hr/attendance/web/group/searchGroup?page=1&size=10&organizationId='+orgId
    ...
    for i in json.loads(back.text)["content"]:
        ...
        url1='https://oretail-ind.myoppo.com/biz-hr/attendance/web/group/deleteGroup?id='+i['id']
        rq.get(url=url1,headers=header)
        print(i['groupName']+'被删除')
